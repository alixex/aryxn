...
export function AppLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="bg-background text-foreground bg-gradient-radial relative min-h-screen overflow-x-clip pb-20 transition-colors duration-300 md:pb-0">
      ...
      <Navbar />
      <main className="relative z-10 container mx-auto max-w-6xl px-4 py-6 sm:py-8 lg:px-8">
        {children}
      </main>
