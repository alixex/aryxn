      ...
      <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        ...
        {isUnlocked && (
          <Button
            ...
            size="sm"
            onClick={onLogout}
            className="border-destructive/25 text-destructive hover:border-destructive/50 hover:bg-destructive/10 bg-[hsl(var(--background)/0.55)] transition-all duration-200 md:cursor-pointer lg:self-start"
          >
